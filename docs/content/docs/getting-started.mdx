...
Cortex has no built-in notion of tenant, workspace, or organization — the host defines its
own scope hierarchy and attaches it to the context, along with the app ID:
